...
uint8 UQPColorWheelHelper::HexToByte(FString Hex)
{   
    uint8 OutDec;
...
FLinearColor UQPColorWheelHelper::RandomLinearColor(bool RandomAlpha, bool TrueRandom)
{
...
FColor UQPColorWheelHelper::RandomColor(bool RandomAlpha, bool TrueRandom)
{
    FColor OutColor;
