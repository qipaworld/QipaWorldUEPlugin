...
#include "Widget/QPColorWheelHelper.h"

// Generated.h
#include "QPColorWidget.generated.h"
 ...
 * * No Children
 */
UCLASS(meta=(DisplayName="QPColor Wheel"))
class QIPAWORLDUEPLUGIN_API UQPColorWidget final : public UWidget
{
	GENERATED_BODY()
...
protected:
	...
	virtual inline const FText GetPaletteCategory() override { return NSLOCTEXT("QP UMG", "QP UMG", "QP UMG"); };
...
private:
	...
	TSharedPtr<QPSWColorWheel> ColorWheel;
	...
	inline FLinearColor GetRGBColor() const { return Color; };
	UFUNCTION(BlueprintPure, Category = "QP Color Wheel")
	inline FLinearColor GetHSVColor() const { return Color.LinearRGBToHSV(); };
